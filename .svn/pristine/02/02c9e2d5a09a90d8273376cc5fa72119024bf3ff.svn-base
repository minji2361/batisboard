...
public class BoardServiceImpl implements BoardService{
	...
	/*
	 * @Override //관리자 게시판 작성글 public List<BoardVo> showNewStatus(BoardVo boardVo) {
	 * List<BoardVo> list = boardDao.showNewStatus(boardVo); return list; }
	 * 
	 * @Override //관리자 게시판 삭제글 public List<BoardVo> showNewDelect(BoardVo boardVo) {
	 * List<BoardVo> list = boardDao.showNewDelect(boardVo); return list; }
	 */
	...
	/*
	 * @Override public int showNewStatusCount(String count) {
	 * 
	 * return 0; }
	 * 
	 * @Override public int showNewDelectCount(String count) {
	 * 
	 * return 0; }
	 */
