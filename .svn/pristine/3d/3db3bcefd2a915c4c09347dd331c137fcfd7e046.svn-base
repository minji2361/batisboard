...
<form name="joinForm" action="joinUser" method="post">
	<table>
		...
		<tr>
			...
			<input class="btn btn-secondary" type="submit" value="홈으로" onClick="javascript: form.action='main';">
			<input class="btn btn-secondary" type="submit" value="회원가입" onClick="inputCheck()">
	</form>
</center>
</div>
