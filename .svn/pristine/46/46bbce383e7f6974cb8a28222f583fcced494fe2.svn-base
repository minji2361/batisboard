	...
	<center>
		<table>
			<%-- <c:if test="${boardVo.boardNumber == null}">
				<tr>
					<td>글쓴이&nbsp;</td>
					<td><input class="form-control mr-sm-2" type="text" name="nickName" style="width:1000px;"/></td>
				</tr>
				<tr>
					<td>제목&nbsp;</td>
				...
				<tr>
					...
					<!-- <select class="custom-select" id="board_item" name="subtitle" 
						style="display: ;width:150px;">
							<option value="food">식품</option>
							<option value="produce">물품</option>
							<option value="etc">기타</option> 
					</select> 
					<select class="custom-select" id="board_lostpet" name="area" 
					...
					<select class="custom-select" id="board_lostpet1" name="subtitle" 
						style="display: none;width:150px;">
							<option value="protecting">보호중</option>
							<option value="searching">찾는중</option>
					</select> 
					<select class="custom-select" id="board_petplace" name="area"
						style="display: none;width:150px;">
							<option value="seoul">서울</option>
							<option value="incheon">인천</option>
							<option value="gwangju">광주</option>
					...
					<select class="custom-select" id="board_petplace1" name="subtitle"
						style="display: none;width:150px;">
							<option value="cafe">카페</option>
							<option value="travel">여행</option>
							<option value="etc">기타</option>
					</select>
					<select class="custom-select" id="board_hospital" name="area"
						style="display: none;width:150px;">
							<option value="seoul">서울</option>
							<option value="incheon">인천</option>
							<option value="gwangju">광주</option>
