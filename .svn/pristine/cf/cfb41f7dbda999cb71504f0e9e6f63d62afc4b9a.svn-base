...
<body>
	...
	<!-- //header -->
		...
		<!-- container -->
	<form method="post" name="writeForm" action="HospitalInsert"
					...
					<tr>
						...
						<td><select class="custom-select" id="board_type" name="type"
							style="width: 150px;" onchange="javascript:change();">
								...
								<option value="hospital">멍냥 치료소</option>
								<option value="petchat">집사들의 수다</option>
						</select> <select class="custom-select" id="board_Hospital" name="subtitle"
						...
						<td>
							<div class="form-group">
								...
								CKEDITOR.replace('content', {
									filebrowserUploadUrl : "hospitalimageUpload.do"
								}); // 에디터로 생성
							</script>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div style="float: right;">
								...
								<a href="/petBoard/hospitalboard"><button class="btn btn-secondary my-2 my-sm-0">뒤로가기</button></a>
							</div>
						</td>
					</tr>
				</c:if>
