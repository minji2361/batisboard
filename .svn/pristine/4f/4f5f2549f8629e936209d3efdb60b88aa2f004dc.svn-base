...
<body>
	...
	<form method="post" name="writeForm" action="itemboardUpload" enctype="multipart/form-data">
	<center>
		<table>
			<c:if test="${boardVo.boardNumber == null}">
				<tr>
					<td>글쓴이&nbsp;</td>
					<td><input class="form-control mr-sm-2" type="text" name="nickName" 
					value="${nickName}" style="width:1000px;" readonly/></td>
				</tr>
				<tr>
                        <td>제목&nbsp;</td>
				...
				<tr>
					...
					<td>
						...
						<a href="petchat"><button class="btn btn-secondary my-2 my-sm-0">뒤로가기</button></a>
						</div>
					</td>
				</tr>
			</c:if>
