	...
	<center>
		<table>
			<c:if test="${nickName == null}">
				<tr>
					<td>글쓴이&nbsp;</td>
					<td><input class="form-control mr-sm-2" type="text" name="writer" style="width:1000px;"/></td>
				</tr>
				<tr>
					<td>제목&nbsp;</td>
					<td><input class="form-control mr-sm-2" type="text" name="title" style="width:1000px;"/></td>
				</tr>
				<tr>
					<td><label>게시판 종류</label></td>
					<td>
					<select class="custom-select" id="board_type" name="board_Type" style="width:150px;"
					...
					<select class="custom-select" id="board_item" name="board_item" 
						style="display: ;width:150px;">
							<option value="food">식품</option>
							<option value="produce">물품</option>
							<option value="etc">기타</option> 
					</select> 
					<select class="custom-select" id="board_lostpet" name="board_lostpet" 
						style="display: none;width:150px;">
							<option value="seoul">서울</option>
							<option value="incheon">인천</option>
							<option value="gwangju">광주</option>
							<option value="dageu">대구</option>
							<option value="dajeon">대전</option>
							<option value="busan">부산</option>
							<option value="ulsan">울산</option>
							<option value="gyeongi">경기</option>
							<option value="gangone">강원</option>
							<option value="cheonam">충남</option>
							<option value="cheonpuk">충북</option>
							<option value="gyengnam">경남</option>
							<option value="gyengpuk">경북</option>
							<option value="joennam">전남</option>
							<option value="joenpuk">전북</option>
							<option value="jeju">제주</option>
					</select> 
					<select class="custom-select" id="board_lostpet1" name="board_lostpet" 
						style="display: none;width:150px;">
							<option value="protecting">보호중</option>
							<option value="searching">찾는중</option>
					</select> 
					<select class="custom-select" id="board_petplace" name="board_petplace"
						style="display: none;width:150px;">
							<option value="seoul">서울</option>
							<option value="incheon">인천</option>
							<option value="gwangju">광주</option>
					...
					<select class="custom-select" id="board_petplace1" name="board_petplace"
						style="display: none;width:150px;">
							<option value="cafe">카페</option>
							<option value="travel">여행</option>
							<option value="etc">기타</option>
					</select>
					<select class="custom-select" id="board_hospital" name="board_hospital"
						style="display: none;width:150px;">
							<option value="seoul">서울</option>
							<option value="incheon">인천</option>
							<option value="gwangju">광주</option>
					...
					<select class="custom-select" id="board_petchat" name="board_petchat"
						style="display: none;width:150px;">
				...
				<tr>
					...
					<td>
						...
						<input type="submit" value="등록하기" onClick="javascript: form.action='petchatInsert';" 
						class="btn btn-secondary my-2 my-sm-0"> 
						<input type="submit" value="뒤로가기" onClick="javascript: form.action='petchat';" 
						class="btn btn-secondary my-2 my-sm-0">
						</div>
					</td>
				</tr>
			...
			<c:if test="${nickName != null}">
				...
				<tr>
					<td>제목&nbsp;</td>
					<td><input class="form-control mr-sm-2" type="text" name="title" value="${board.title}" style="width:1000px;"/></td>
				</tr>
				<tr>
					<!--  <td>내용&nbsp;</td>
				<td><textarea name="content" rows="13" cols="50">${board.content}</textarea></td>  -->
					<td>내용&nbsp;</td>
					<td><textarea id="content" rows=10 name="content">${board.content}</textarea>
						<script>
							CKEDITOR.replace('content'); // 에디터로 생성
						</script></td>
				</tr>
				<tr>
					...
					<input type="submit" value="수정하기"
						onClick="javascript: form.action='update?id=${board.id}';">
						<input type="submit" value="뒤로가기"
						onClick="javascript: form.action='petchat';">
					</td>
				</tr>
			</c:if>
		</table>
