	...
	<form method="post" name="form" enctype="multipart/form-data">
		...
		<c:if test="${id == null}">
			...
			<tr>
				...
				<td>
					<select class="combo" id="board_type" name="board_Type" onchange="javascript:change();">  
						<option value="item"> 멍냥잡화점 </option>  
						<option value="hospital"> 동물병원  </option>  
						<option value="petchat"> 집사들의 수다 </option>  
					</select>  
					<select class="combo" id="board_item" name="board_item" style="display:none">  
						<option value="food"> 식품 </option>  
						<option value="produce"> 물품  </option>  
						<option value="etc"> 기타 </option>  
					</select> 
					<select class="combo" id="board_petchat" name="board_petchat" style="display:none">  
						<option value="introduce"> 멍냥소개 </option>  
		...
		<c:if test="${id != null}">
			...
			<tr>
				...
				<td>내용&nbsp;</td>
				<td>
				<textarea id="content" rows=10  name="content">${board.content}</textarea>
				<script >
				CKEDITOR.replace('content'); // 에디터로 생성
				</script >
				</td>
		...
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f850654c021fcb52efb271b62ce441eb&libraries=services"></script>
		<div class="map_wrap">
		    ...
		    <div id="menu_wrap" class="bg_white">
		        <div class="option">
		            <div>
		                  ...
		                  <input type="button" value="검색" id="searchBtn" onClick="searchPlaces()"> 
		            </div>
		        </div>
		        <hr>
		        <ul id="placesList"></ul>
					    ...
					    for ( var i=0; i<places.length; i++ ) {
					        ...
					        (function(marker, title) {
					            kakao.maps.event.addListener(marker, 'click', (function(placePosition) {
					                ...
					                return function(){
					                	console.log("placePosition.La:" + placePosition.La);
					                	console.log("placePosition.Ma:" + placePosition.Ma);
