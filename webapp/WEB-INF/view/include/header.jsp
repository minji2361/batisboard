 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarColor03">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/petBoard/itemboard?oder=recent">멍냥잡화점</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/petBoard/lostpetboard?oder=recent">구해줘펫즈</a>
      </li>
      <li class="nav-item">
         <a class="nav-link" href="/petBoard/petplaceboard?oder=recent">멍냥여행사</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/petBoard/petchat?oder=recent">집사들의 수다</a>
      </li> 
      <li>
      </li>  
    </ul>
