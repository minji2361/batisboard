...
<script type="text/javascript">
	...
	function list(page){
		location.href = "petchat?curPage="+page;
	}
/* 9-15 */
</script>
...
<div class ="container">
	...
	<div style='width:80px;float: right;'>
		<a href="petchatWritePage"><button type="submit" class="btn btn-outline-secondary">글쓰기</button></a>
	</div>
    ...
    <tr>
      ...
      <th scope="col">추천수</th>
			...
			<tr>
				...
				<%-- 
				<td>
					<a href="<c:url value="/petchatContent/${notice.boardNumber}" />" id="notice" class="notice">
				 ...
				 <td>
					<c:choose>
						<c:when test="${fn:contains(list.notice, 'y')}">
							<a href="<c:url value="/petchatContent/${list.boardNumber}" />" id="notice" class="notice"> 
							${list.subtitle}&nbsp;${list.title}[${replyCount}]
							</a>
						</c:when>
						<c:otherwise>
							<a href="<c:url value="/petchatContent/${list.boardNumber}" />">
							[${list.subtitle}]&nbsp;${list.title}[${replyCount}]
							</a>
						</c:otherwise>
					</c:choose> 
