...
<body>
	...
	<!-- container -->
	<form method="post" name="writeForm" action="lostpetWrite"
				...
				<c:if test="${boardVo.boardNumber == null}">
					<tr>
						...
						<td><input class="form-control mr-sm-2" type="text"
							name="nickName" value="${nickName}" style="width: 100px;" readonly/></td>
					</tr>
					<tr>
						<td>제목&nbsp;</td>
						<td><input class="form-control mr-sm-2" type="text"
						...
						<td>
							<div class="form-group">
								...
								CKEDITOR.replace('content', {
									filebrowserUploadUrl : "lostpetImageUpload.do"
								}); // 에디터로 생성
							</script>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div style="float: right;">
								...
								<button class="btn btn-secondary my-2 my-sm-0"><a href="/petBoard/lostpetboard" class="toBack">뒤로가기</a></button>
							</div>
						</td>
					</tr>
				</c:if>
